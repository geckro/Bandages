...
namespace Bandages.Recipes
{
	public class ThoriumToCalamityRecipes : ModSystem
	{
		public override void AddRecipes()
		{
			Mod thorium;
			Mod calamity;
			if (ModLoader.TryGetMod("ThoriumMod", out thorium) && ModLoader.TryGetMod("CalamityMod", out calamity))
			{
				// POST PLANTERA				> POST MOON LORD
				// THORIUM						> CALAMITY
				// TerrariumParticleSprinters > CelestialTracers
				if (
	...
	public class CalamityToThoriumRecipes : ModSystem
	{
	}
	...
	public class ThoriumEditItems : GlobalItem
	{
		public class ThoriumPax : GlobalItem
		{
			...
			public override bool AppliesToEntity(Item item, bool lateInstatiation)
			{
				...
				{
					if (
						thorium.TryFind<ModItem>("ThoriumPax", out ModItem thoriumPickaxeAxe)
					)
					{
